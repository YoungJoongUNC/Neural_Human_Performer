...
parser.add_argument('--human_idx', type=str)
...
data_root = 'data/mesh/{}/epoch_{}/{}/{}'.format(args.exp_name, args.epoch,args.exp_folder_name,args.human_idx)
obj_path = os.path.join(data_root, '{}.ply'.format(args.frame_idx))

mesh_render_dir = os.path.join(data_root, 'renderings')
